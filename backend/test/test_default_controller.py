...
def test_valid_get_vm_id(client, init_user_database, init_vm_database, monkeypatch):
    ...
    response = client.get('/vm/1', headers={'Content-Type': 'application/json', "Authorization" : "Bearer AT-232-ZAlr3TdJmZbGkL173Al8xm1VWSPnJTpy"})
    print(response.json)
...
def test_foreign_get_vm_id(client, init_user_database, init_vm_database, monkeypatch):
    ...
    response = client.get('/vm/3', headers={'Content-Type': 'application/json', "Authorization" : "Bearer AT-232-ZAlr3TdJmZbGkL173Al8xm1VWSPnJTpy"})
    assert response.status_code == 403
...
def test_admin_get_vm_id(client, init_user_database, init_vm_database, monkeypatch):
    ...
    vm1 = client.get('/vm/3', headers={'Content-Type': 'application/json', "Authorization" : "Bearer AT-232-ZAlr3TdJmZbGkL173Al8xm1VWSPnJTpy"})
    vm2 = client.get('/vm/1', headers={'Content-Type': 'application/json', "Authorization" : "Bearer AT-232-ZAlr3TdJmZbGkL173Al8xm1VWSPnJTpy"})
...
def test_valid_delete_vm_id(client, init_user_database, init_vm_database, monkeypatch):    
    ...
    response = client.delete('/vm/1', headers={'Content-Type': 'application/json', "Authorization" : "Bearer AT-TEST"})
...
def test_foreign_delete_vm_id(client, init_user_database, init_vm_database, monkeypatch):    
    ...
    response = client.delete('/vm/3', headers={'Content-Type': 'application/json', "Authorization" : "Bearer AT-TEST"})
    assert response.status_code == 403
...
def test_admin_delete_vm_id(client, init_user_database, init_vm_database, monkeypatch):
    ...
    vm1 = client.delete('/vm/1', headers={'Content-Type': 'application/json', "Authorization" : "Bearer AT-TEST"})
    vm2 = client.delete('/vm/3', headers={'Content-Type': 'application/json', "Authorization" : "Bearer AT-TEST"})
...
def test_valid_delete_vm_with_error_id(client, init_user_database, init_vm_database, monkeypatch):    
    ...
    response = client.delete('/vmWithError/1', headers={'Content-Type': 'application/json', "Authorization" : "Bearer AT-TEST"})
    assert response.status_code == 200
...
def test_foreign_delete_vm_with_error_id(client, init_user_database, init_vm_database, monkeypatch):    
    ...
    response = client.delete('/vmWithError/3', headers={'Content-Type': 'application/json', "Authorization" : "Bearer AT-TEST"})
    assert response.status_code == 403
...
def test_admin_delete_vm_with_error_id(client, init_user_database, init_vm_database, monkeypatch):
    ...
    vm1 = client.delete('/vmWithError/1', headers={'Content-Type': 'application/json', "Authorization" : "Bearer AT-TEST"})
    vm2 = client.delete('/vmWithError/3', headers={'Content-Type': 'application/json', "Authorization" : "Bearer AT-TEST"})
    assert vm1.status_code == 200
    assert vm2.status_code == 200
...
def test_foreign_patch_vm(client, init_user_database, init_vm_database, monkeypatch):
    ...
    # Not his vm
    response = client.patch('/vm/3', headers={'Content-Type': 'application/json', "Authorization" : "Bearer AT-TEST"}, json={"status": "start"})
    assert response.status_code == 403
...
def test_valide_ressources_fetchdef(client, init_max_ressources_for_one_user, monkeypatch):
    monkeypatch.setattr(util, "check_cas_token", fake_check_cas_token)
    response = client.get('/max_account_ressources', headers={'Content-Type': 'application/json', "Authorization" : "Bearer AT-232-ZAlr3TdJmZbGkL173Al8xm1VWSPnJTpy"})
    assert response.status_code == 200